(function (factory) {
  ...
  var mc = new MCanvas({
    width: 1000,
    height: 1500 // backgroundColor: 'black',
  ...
  function showDialog(type, ops) {
    ...
    switch (type) {
      case 'image':
        html = "<li>image:'".concat(ops.image, "'</li>\n                    <li>options:{</li>\n                    <li>").concat(tab, "width:<input data-type='width' class='js-input input' type='text' value='").concat(ops.options.width, "'></li>\n                    <li>").concat(tab, "pos:{</li>\n                    <li>").concat(tab + tab, "x:<input data-type='x' class='js-input input' type='text' value='").concat(ops.options.pos.x, "'></li>\n                    <li>").concat(tab + tab, "y:<input data-type='y' class='js-input input' type='text' value='").concat(ops.options.pos.y, "'></li>\n                    <li>").concat(tab + tab, "scale:<input data-type='scale' class='js-input input' type='text' value='").concat(ops.options.pos.scale, "'></li>\n                    <li>").concat(tab + tab, "rotate:<input data-type='rotate' class='js-input input' type='text' value='").concat(ops.options.pos.rotate, "'></li>\n                    <li>").concat(tab, "}</li>\n                    <li>}</li>");
        break;
