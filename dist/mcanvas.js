(function (global, factory) {
  ...
  function _iconHover () {
    ...
    var _$extend = _.extend({}, options),
        icon = _$extend.icon,
        color = _$extend.color;

    var cvs = document.createElement('canvas');
    var ctx = cvs.getContext('2d');

    _.getImage(icon, function (img) {
  ...
  MCanvas.prototype._background = function (img, bg) {
    var _this$_getSize = this._getSize(img),
        iw = _this$_getSize.iw,
        ih = _this$_getSize.ih; // 图片与canvas的长宽比；
  ...
  MCanvas.prototype._add = function (img, ops) {
    ...
    var _this$_getSize2 = this._getSize(img),
        iw = _this$_getSize2.iw,
        ih = _this$_getSize2.ih; // let ratio = iw / ih;
    // 画布canvas参数；
  ...
  MCanvas.prototype._handleOps = function (ops, img) {
    ...
    var _this$_getSize3 = this._getSize(img),
        iw = _this$_getSize3.iw,
        ih = _this$_getSize3.ih; // 图片宽高比；
